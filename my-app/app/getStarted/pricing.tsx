              ...
              <div className="grid grid-cols-2 gap-6 *:p-8">
                ...
                >
                  <div className="card-content relative z-10 flex h-full flex-col">
                    ...
                    {/* Price & Duration */}
                    <div className="mb-6">
                      <span className="text-foreground text-3xl font-semibold dark:text-black">
                        <PriceFlow value={0} />€
                      </span>
                      <span className="text-foreground/70 mx-2 dark:text-black">•</span>
                ...
                >
                  ...
                  <div className="card-content relative z-10 flex h-full flex-col">
                    {/* Title */}
                    <h3 className="text-white dark:text-black mb-4 text-2xl font-bold">
                      Pro
                    </h3>

                    {/* Price & Duration */}
                    <div className="mb-6 text-white">
                      <span className="text-white text-3xl font-semibold dark:text-black">
                        <PriceFlow value={isAnnual ? 12 : 25} />€
                      </span>
                      <span className="text-white mx-2">•</span>
                      <span className="text-white mx-2 dark:text-black">Per month</span>
                    </div>

                    {/* CTA Button */}
                    <button
                      type="button"
                      className="bg-foreground   text-background hover:bg-foreground/90 focus-visible:ring-ring mb-6 inline-flex h-10 w-full cursor-pointer items-center justify-center gap-2 rounded-md px-4 py-2 text-sm font-medium transition-colors focus-visible:ring-1 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 dark:text-black"
                    >
                      Get Started
                    </button>

                    {/* Description */}
                    <p className="text-white mb-6 flex-grow text-sm leading-relaxed dark:text-black">
                    ...
                    {/* What's Included */}
                    <div className="space-y-4">
                      <h4 className="text-white text-xs font-medium tracking-wider uppercase dark:text-black">
                        What&apos;s included:
                      </h4>
                      <ul className="space-y-3">
                        {[
                          ...
                          <li
                            className="text-white flex items-center gap-3 text-sm dark:text-black"
                            key={item}
                          >
                            <div className="bg-white flex h-4 w-4 flex-shrink-0 items-center justify-center rounded-full dark:text-black">
                              <svg
                                className="text-background h-2 w-2"
                                fill="currentColor"
                                viewBox="0 0 20 20"
