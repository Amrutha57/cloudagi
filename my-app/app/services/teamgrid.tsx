  ...
  return (
    <section className="bg-white dark:bg-gray-900 py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        >
          <h2 className="text-gray-700 dark:text-gray-100 text-4xl font-semibold tracking-tight sm:text-5xl">
            {title}
          </h2>
          <p className="text-gray-600 dark:text-gray-400 mt-6 text-lg/8">{description}</p>
        </motion.div>
          ...
          {members.map((member, index) => (
            ...
            >
              ...
              >
                ...
                {/* Name */}
                <h3 className="text-gray-900 dark:text-gray-100 mt-6 text-lg/8 font-semibold tracking-tight">
                  {member.name}
                </h3>

                {/* Role */}
                <p className="text-gray-600 dark:text-gray-400 text-base/7">{member.role}</p>

                {/* Location */}
                {member.location && (
                  <p className="text-gray-600 dark:text-gray-400 text-sm/6">{member.location}</p>
                )}
