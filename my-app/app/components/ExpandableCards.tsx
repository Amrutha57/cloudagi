  ...
  return [
    {
      ...
      content: "Help businesses define AI adoption strategies and roadmap aligned with their goals.",
      author: {
        name: "Amrutha",
        role: "CEO & Founder",
        image: "/airesearch.png",
...
export default function ExpandableCards({
  ...
  return (
    <div
      className={`flex w-full flex-col gap-4 overflow-visible p-4 ${className}`} /* changed overflow-scroll to overflow-visible */
    >
      <div
        ref={scrollRef}
